...
# shutil.copytree('./output/train_marigold/checkpoint/latest', './output/train_marigold/checkpoint/_old_latest', dirs_exist_ok=True)
# shutil.rmtree('./output/train_marigold/checkpoint/latest')
...
if "__main__" == __name__:
    ...
    if resume_run is not None:
        ...
        cfg = OmegaConf.load("./output/train_marigold/config.yaml")
    else:
        # Run from start
        ...
        #if not os.path.existsout_dir_run)
    ...
    # model = MarigoldPipeline.from_pretrained(model_id,force_download=True)
